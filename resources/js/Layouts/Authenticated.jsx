...
export default function Authenticated({ auth, children, ...props }) {
    ...
    //         label: <Link href={route('dashboard')}>{lang.get('strings.Dashboard')}</Link>
    //     }, {
    //         key: 'customer',
    //         icon: <UserOutlined />,
    //         label: <Link href={route('customers.index')}>{lang.get('strings.Customers')}</Link>
    //     }, {
    //         key: 'order',
    //         icon: <CalendarOutlined />,
    //         label: <Link href={route('orders.index')}>{lang.get('strings.Order')}</Link>
    //     }, {
    //         key: 'staff',
    //         icon: <UserOutlined />,
    //         label: <Link href={route('orders.index')}>{lang.get('strings.Staff')}</Link>
    //     }, {
    //         key: 'product',
    //         icon: <ExperimentOutlined />,
    //         label: <Link href={route('orders.index')}>{lang.get('strings.Product')}</Link>
    //     }, {
    //         key: 'category',
